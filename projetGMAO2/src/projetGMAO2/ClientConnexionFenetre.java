...
public class ClientConnexionFenetre extends JPanel {
    ...
    public ClientConnexionFenetre(JFrame parentFrame) {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    if (resultFonction) {
                        ...
                        ResponsableInterface clientInterface = new ResponsableInterface(parentFrame);
